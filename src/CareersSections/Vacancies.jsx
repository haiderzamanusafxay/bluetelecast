  ...
  return (
    <section className="py-24">
      <div className="text-center w-full mx-auto md:w-11/12 xl:w-9/12 md:text-center">
        ...
        <h1 className="font-bold text-2xl leading-[1.1] sm:text-3xl md:text-4xl mt-8">
          <span className="block w-full py-2 text-gray-900 bg-clip-text leading-12 lg:inline">
            List of vacancies
          </span>
        </h1>
        <ul class="p-8 list-disc list-inside text-start bg-gray-50 w-11/12 m-auto rounded shadow-md mt-10 grid sm:grid-cols-2 md:grid-cols-3">
