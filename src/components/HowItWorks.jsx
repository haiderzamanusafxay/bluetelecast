          ...
          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-2 text-center">
              <h2 className="mb-2 text-3xl font-extrabold leading-tight text-dark-grey-900 lg:text-4xl">
                How it works at Bluetelecast?
              </h2>
              <p className="text-base font-medium leading-7 text-dark-grey-600">
                Here is a breakdown of all the steps you need in order to get
                our services.
              </p>
            </div>
          </div>
          <div className="flex w-full flex-col items-center justify-between gap-y-10 lg:flex-row lg:gap-x-8 lg:gap-y-0 xl:gap-x-10">
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-base font-medium leading-7 text-dark-grey-600">
                  You fill the form and give us a brief description of your
                  project.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-base font-medium leading-7 text-dark-grey-600">
                  Our team will review your project and analyze it.
                </p>
              </div>
            </div>
            <div className="rotate-90 lg:rotate-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-base font-medium leading-7 text-dark-grey-600">
                  Our teams contact you after reviewing your project.
                </p>
              </div>
            </div>
          </div>
