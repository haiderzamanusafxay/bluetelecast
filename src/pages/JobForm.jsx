...
const JobForm = () => {
  return (
    <>
      <div className="flex justify-center items-center w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-gray-100">
        <div className="bg-white max-w-4xl rounded-xl shadow p-4 sm:p-7 ">
          <form>
              ...
              <div className="sm:col-span-9">
                <div className="sm:flex">
                  <input
                    ...
                    type="text"
                    className="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm -mt-px -ms-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-s-lg sm:mt-0 sm:first:ms-0 sm:first:rounded-se-none sm:last:rounded-es-none sm:last:rounded-e-lg text-sm relative border-2 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none     "
                  />
                  <input
                    type="text"
                    className="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm -mt-px -ms-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-s-lg sm:mt-0 sm:first:ms-0 sm:first:rounded-se-none sm:last:rounded-es-none sm:last:rounded-e-lg text-sm relative border-2 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none     "
            ...
            <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200     ">
              ...
              <div className="sm:col-span-3">
                <label
                  for="af-submit-application-github-url"
                  className="inline-block text-sm font-medium text-gray-500 mt-2.5"
                >
                  Github URL
                </label>
              ...
              <div className="sm:col-span-3">
                <label
                  for="af-submit-application-portfolio-url"
                  className="inline-block text-sm font-medium text-gray-500 mt-2.5"
                >
                  Portfolio URL
                </label>
              ...
              <div className="sm:col-span-3">
                <label
                  for="af-submit-application-other-website"
                  className="inline-block text-sm font-medium text-gray-500 mt-2.5"
                >
                  Other website
                </label>
